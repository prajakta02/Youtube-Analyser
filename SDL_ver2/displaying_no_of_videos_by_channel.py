...
count_videos_df=youtube_vid['channel_title'].value_counts(ascending=True)


Label(root, text=" ~ Count of videos by channel ~ ",font=(" ",24),width=30,bg='black',fg='white').place(x=350,y=190)
Label(root, text=count_videos_df,font=(" ",15),width=70).place(x=360,y=290)
